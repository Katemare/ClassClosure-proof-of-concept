...
([
	...
	[
		...
		[
			...
			'zoo_list'=>['zoo', 'zoo_beta'],
			
			// the following liies are commented because of bug #70106 that's already fixed in the ongoing repo. this bug renders impossible the only way to extend from an anonymous class: by creating a class_alias. uncomment these lines at later date when the fix is released to test inheriting from an anonymous class.
